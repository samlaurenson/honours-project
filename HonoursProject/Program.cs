...
namespace HonoursProject
{
    class Program
    {
        ...
        async static Task Main(string[] args)
        {
            ...
            //File.WriteAllText(@"..\..\..\outputFile.json", json); //to test that data is json compatible as if json can be written - then will be able to send to server with no problems
